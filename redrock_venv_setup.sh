...
#         DESI dependencies).
dload_desi_pkg "speclite" "v0.15"
dload_desi_pkg "desiutil" "3.2.5"
dload_desi_pkg "desitarget" "0.22.0"
dload_desi_pkg "desimodel" "0.9.6"
dload_desi_pkg "specter" "0.8.6"
dload_desi_pkg "desispec" "0.27.1"
dload_desi_pkg "desisim" "0.28.0"
dload_desi_pkg "redrock-templates" "0.7.2"
dload_desi_pkg "redrock" "0.13.2"

mkdir -p "redrock-0.13.2/py/redrock/templates"
cp -Rf "redrock-templates-0.7.2"/* "redrock-0.13.2/py/redrock/templates/"

# Step 5: install the packages in the correct order
install_desi_pkg "speclite-0.15"
install_desi_pkg "desiutil-3.2.5"
...
install_desi_pkg "redrock-0.13.2"
